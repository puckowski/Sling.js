...
Sling is a client-side JavaScript framework for building Single Page Applications (SPAs). Sling is lightweight, **7.3KB minified, and less than 2.6KB gzipped**.
...
Sling.js creates nodes **3.483** times faster than Angular.
...
Sling.js changes nodes **4.790** times faster than Angular in manual change detection mode and changes nodes **2.972** times faster than Angular in automatic change detection mode.
